---
title: "Compare GCNs: Pbar DD v. LD (ref)"
...
setLabels = c("Pbar-LD", "Pbar-DD")
shortLabels = c("Pbar-LD", "Pbar-DD")
...
multiExpr[[1]] = list(data = as.data.frame(t(log2(samples.list[[1]][-c(1)]+1))));
names(multiExpr[[1]]$data) = samples.list[[1]]$gene_name;
rownames(multiExpr[[1]]$data) = names(samples.list[[1]])[-c(1)];

multiExpr[[2]] = list(data = as.data.frame(t(log2(samples.list[[2]][-c(1)]+1))));
names(multiExpr[[2]]$data) = samples.list[[2]]$gene_name;
rownames(multiExpr[[2]]$data) = names(samples.list[[2]])[-c(1)];
...
#                       "/results/module_preservation/pbar_ld_dd/modulePreservation_Pbar_LD_v_DD.RData"));
