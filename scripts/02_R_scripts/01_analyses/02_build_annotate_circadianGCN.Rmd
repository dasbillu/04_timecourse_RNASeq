...
load(paste0(path_to_repo, "/results/wgcna_files/ref",
                   which.sample,"sim_matrix_", sample.name[1], "_TC9.RData")) # load it up
...
# save(adj_matrix, 
#      file = paste0(path_to_repo, "/results/wgcna_files/ref",
#                    which.sample,"adj_matrix_", sample.name[1], "_TC9.RData")) # might be useful to save the sim_matrix and
load(paste0(path_to_repo, "/results/wgcna_files/ref",
                   which.sample,"adj_matrix_", sample.name[1], "_TC9.RData")) # load it up
